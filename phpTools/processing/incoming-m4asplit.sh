...
echo "\tChecking length of converted WAV audio ${FPATH_FULL_WAV_SRC}"
...
echo "\tRemoving source m4a $FPATH_SRC"
rm "$FPATH_SRC"
...
echo "\tConverting full source recording to mp3"
	echo "\t\tplease wait - this could take several minutes to process"
	...
	echo "\tRemoving WAV copy of full recording (WAV splitparts remain)"
